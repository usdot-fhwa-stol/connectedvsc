...
Welcome to the ConnectedVCS Tools contributing guide. There are a few guidelines that we need contributors to follow so that we can have a chance of keeping on top of things.
...
* Submit a [ConnectedVCS Tools issue](<docs/ISSUE_TEMPLATE.md>).
