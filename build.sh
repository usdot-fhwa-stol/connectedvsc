sudo rm -rf /home/vboxuser/connectedvcs-tools/fedgov-cv-mapencoder/logs/cv-mapencoder.log
sudo rm -rf /home/vboxuser/connectedvcs-tools/fedgov-cv-mapencoder/applogs
sudo rm -rf /home/vboxuser/connectedvcs-tools/fedgov-cv-message-builder/logs/cv-message-builder.log
