...
public class MotorVehicleLaneGeometryLayer {
    ...
    public List<IndvMtrVehLaneGeometryInfo> getLaneGeomLaneSet() {
    ...
    public String toString() {
        return "MotorVehicleLaneGeometryLayer [laneGeomLaneSet="
                + (laneGeomLaneSet != null ? laneGeomLaneSet.toString() : "null") + "]";
    }
}
